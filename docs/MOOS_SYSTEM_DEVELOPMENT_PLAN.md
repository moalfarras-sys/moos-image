...
| P01 | P1 measured, policy open | Capability-based workload budget | Measure idle, typing, scroll/video, build and AI separately; compare frame/input p50/p95, CPU, memory and network before/after on identical workload |
