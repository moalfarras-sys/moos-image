...
| --- | --- | --- | --- |
| Station agent | The physical x86 NVIDIA workstation | Nothing claimed. W9.9 "MoOS One inside KDE" (PR #164) is merged and promoted; next on this station: the installed-desktop proof of W9.9 once the owner restarts into the promoted image. | — |
