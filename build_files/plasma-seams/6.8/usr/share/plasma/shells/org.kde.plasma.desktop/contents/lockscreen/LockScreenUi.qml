/*
    ...
    PLASMA 6.8 SEAM. This copy is re-derived from plasma-desktop 6.7.90 (6.8
    beta) by a three-way merge of MoOS's 6.7 visual additions onto the new
    ...
    Upstream 6.8 replaced the footer with LoginLockScreen.Footer, removed
