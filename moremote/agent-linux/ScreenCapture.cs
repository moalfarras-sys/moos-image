...
public sealed class ScreenCapture : IDisposable
{
    ...
    public ScreenCapture() => UpdateInputGeometry();
    ...
    private void UpdateInputGeometry()
    {
        try
        {
            ...
            if (!p.WaitForExit(3000) || p.ExitCode != 0) return;
            ...
            if (maxX>minX&&maxY>minY) { _inputLeft=minX;_inputTop=minY;_inputWidth=maxX-minX;_inputHeight=maxY-minY; Log.Info($"KDE logical input geometry: {_inputLeft},{_inputTop} {_inputWidth}x{_inputHeight}."); }
        }
