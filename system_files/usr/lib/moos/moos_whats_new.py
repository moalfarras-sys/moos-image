...
def whats_new_state(previous_built: int, path: Path | None = None) -> dict[str, object]:
    """The shipped list, newest first, as the page and the notification will present it."""
