...
Item {
    ...
    property var panelMask: floatingness === 0 ? (materialOpacity === 1 ? opaqueItem.mask : translucentItem.mask) : (materialOpacity === 1 ? floatingOpaqueItem.mask : floatingTranslucentItem.mask)
    ...
    KSvg.FrameSvgItem {
        id: translucentItem
        opacity: root.translucentMaterialOpacity
        visible: root.floatingness === 0 && root.materialOpacity !== 1
    ...
    KSvg.FrameSvgItem {
        ...
        visible: root.floatingness !== 0 && root.materialOpacity !== 0
    ...
    KSvg.FrameSvgItem {
        id: opaqueItem
        visible: root.materialOpacity !== 0 && root.floatingness === 0
        opacity: root.materialOpacity
        enabledBorders: panel.enabledBorders
        anchors.fill: floatingTranslucentItem
        imagePath: containment?.plasmoid?.backgroundHints === PlasmaCore.Types.NoBackground ? "" : "solid/widgets/panel-background"
