    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            Avatar {
                ...
                tooltipText: active && selector.listUsers ? (Config.avatarAlwaysActive ? "" : "إغلاق اختيار المستخدم | Close user selection") : (active && !listUsers ? "اختيار مستخدم | Select user" : model.name)
