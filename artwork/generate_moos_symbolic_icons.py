...
SYMBOLS.update({
    ...
    "notification": sym(
        ...
        path("M6.5 14A5.5 5.5 0 0 1 17.5 14L16.5 16.5A1.5 1.5 0 0 1 15 17.5H9A1.5 1.5 0 0 1 7.5 16.5Z"),
        path(circle(12, 20, 1.5)),
        path(circle(17.5, 5.5, 1.5), HIGHLIGHT),
    ),
    "download": sym(
        "Download", "actions",
        path(capsule(12, 3, 12, 16.5, 2.2)),
        path(polygon(((7, 13), (12, 18.5), (17, 13), (14, 13), (12, 15.5), (10, 13))), HIGHLIGHT),
        path(rect(3.5, 17.5, 17, 5, 2.5)),
    ),
    "upload": sym(
        "Upload", "actions",
        path(capsule(12, 21, 12, 7.5, 2.2)),
        path(polygon(((7, 11), (12, 5.5), (17, 11), (14, 11), (12, 8.5), (10, 11))), HIGHLIGHT),
        path(rect(3.5, 17.5, 17, 5, 2.5)),
    ),
    "folder": sym(
        "Folder", "files",
        compound(
            "M3 18.5V7C3 5.6 4 4.5 5.5 4.5H9L11 6.5H18.5C20 6.5 21 7.6 21 9V18.5C21 19.9 20 21 18.5 21H5.5C4 21 3 19.9 3 18.5Z",
            rect(4.5, 10.5, 15, 3.5, 1.2),
        ),
        path(rect(16, 14.5, 3.5, 2, .6), HIGHLIGHT),
        min_holes=1,
    ),
    "terminal": sym(
        "Terminal", "development",
        path(rect(2.5, 3.5, 19, 17, 2.8)),
        path(polygon(((6.5, 8.5), (10.5, 11.5), (6.5, 14.5))), HIGHLIGHT),
        path(polygon(((12.5, 7.5), (12.5, 8.5), (18.5, 8.5)))),
        path(polygon(((11.5, 13.5), (11.5, 14.5), (18.5, 14.5)))),
    ),
    "clock": sym(
        "Clock", "time",
        path(ring(12, 12, 9.6, 7.3)),
        path(capsule(12, 12, 12, 6.5, 1.8), HIGHLIGHT),
        path(capsule(12, 12, 16.5, 12, 1.8)),
        path(circle(12, 12, 1.6)),
        min_holes=1,
    ),
    "calendar": sym(
        "Calendar", "time",
        compound(
            rect(2.5, 4.5, 19, 16.5, 2.8),
            rect(4.5, 6.5, 15, 4, .8),
            capsule(9, 3.2, 9, 4.5, 1),
            capsule(15, 3.2, 15, 4.5, 1),
        ),
        path(rect(5, 12, 6, 1.5, .4), HIGHLIGHT),
        path(rect(5, 15, 6, 1.5, .4)),
        min_holes=2,
    ),
    "battery": sym(
        "Battery", "hardware",
        path(rect(2.5, 5, 18, 14, 2.8)),
        path(rect(20.5, 8, 2, 8, 1)),
        path(rect(5, 8, 6, 8, 1.2), HIGHLIGHT),
        path(rect(12.5, 8, 3, 8, 1.2)),
        min_holes=0,
    ),
    "wifi": sym(
        "WiFi", "connectivity",
        path(arc_band(12, 12.5, 10.5, 8.2, -60, 60)),
        path(arc_band(12, 12.5, 7.3, 5.2, -60, 60)),
        path(arc_band(12, 12.5, 4.2, 2.3, -60, 60), HIGHLIGHT),
        path(circle(12, 19.5, 1.8)),
        min_holes=0,
    ),
    "menu": sym(
        "Menu", "navigation",
        path(capsule(3.25, 5.5, 20.75, 5.5, 2)),
        path(capsule(3.25, 12, 20.75, 12, 2)),
        path(capsule(3.25, 18.5, 20.75, 18.5, 2), HIGHLIGHT),
    ),
    "about": sym(
        "About", "status",
        path(ring(12, 12, 9.75, 7.5)),
        path(circle(12, 8.5, 1.2)),
        path(capsule(12, 11.5, 12, 17.5, 2), HIGHLIGHT),
        min_holes=1,
    ),
    "user": sym(
        "User", "system",
        path(circle(12, 7.5, 4.5)),
        path("M3 20.5C3 15.5 7 13.5 12 13.5C17 13.5 21 15.5 21 20.5Z"),
        path(circle(12, 7.5, 2), HIGHLIGHT),
        min_holes=0,
    ),
    "heart": sym(
        "Favourite", "status",
        path("M12 20.5C5.5 14.5 2.5 10.5 3.5 7C4.5 3.5 8.5 3 12 6C15.5 3 19.5 3.5 20.5 7C21.5 10.5 18.5 14.5 12 20.5Z"),
        path(circle(8.5, 6.5, .8), HIGHLIGHT),
    ),
    "play": sym(
        "Play", "media",
        path(polygon(((6, 3), (6, 21), (20, 12))), HIGHLIGHT),
    ),
    "pause": sym(
        "Pause", "media",
        path(rect(5, 3, 5.5, 18, 2.8)),
        path(rect(13.5, 3, 5.5, 18, 2.8), HIGHLIGHT),
    ),
    "volume": sym(
        "Volume", "media",
        path(polygon(((6, 8.5), (10, 8.5), (16, 3.5), (16, 20.5), (10, 15.5), (6, 15.5)))),
        path(arc_band(16, 12, 5.5, 3.5, -50, 50), HIGHLIGHT),
        path(arc_band(16, 12, 6.5, 4.5, -50, 50)),
    ),
    "volume-off": sym(
        "Volume off", "media",
        path(polygon(((6, 8.5), (10, 8.5), (16, 3.5), (16, 20.5), (10, 15.5), (6, 15.5)))),
        path(capsule(16, 9, 21, 15, 2.2)),
        path(capsule(21, 9, 16, 15, 2.2), HIGHLIGHT),
    ),
    "image": sym(
        "Image", "media",
        compound(
            rect(2.25, 3.25, 19.5, 17.5, 2.8),
            rect(5, 6, 7, 7, 1.5),
        ),
        path(polygon(((13.5, 13.5), (21.75, 7.5), (21.75, 19), (3.5, 19))), HIGHLIGHT),
        path(circle(8.5, 9.5, 1.2)),
        min_holes=1,
    ),
    "pin": sym(
        "Pin", "navigation",
        compound(
            "M12 2.5C7 2.5 4 6 4 10C4 16 12 21.5 12 21.5C12 21.5 20 16 20 10C20 6 17 2.5 12 2.5Z",
            circle(12, 9.5, 3),
        ),
        path(circle(12, 9.5, 1.5), HIGHLIGHT),
        min_holes=1,
    ),
    "cast": sym(
        "Cast", "connectivity",
        path(rect(2.25, 8.5, 19.5, 12, 2.5)),
        path(rect(19.5, 4, 2.5, 3.5, 1)),
        path(circle(8, 17, 2.5)),
        path(arc_band(8, 16.5, 5.5, 3, -90, 90), HIGHLIGHT),
        path(arc_band(8, 16, 6, 3.5, -90, 90)),
    ),
    "help": sym(
        "Help", "status",
        path(ring(12, 12, 9.75, 7.5)),
        path("M12 16.5V15.5C12 13 15 12.5 15 10.5C15 8.5 13.5 7.5 12 7.5C10.5 7.5 9.5 8.5 9.5 10"),
        path(circle(12, 18, 1.2), HIGHLIGHT),
        min_holes=1,
    ),
    "pulse": sym(
        "Activity", "status",
    ...
    "login": sym(
        "Login", "navigation",
        path(capsule(4, 12, 16.5, 12, 2.2)),
        path(polygon(((10, 5.5), (18.5, 12), (10, 18.5), (10, 15), (6, 15), (6, 9), (10, 9))), HIGHLIGHT),
    ),
    "logout": sym(
        "Logout", "navigation",
        path(capsule(20, 12, 7.5, 12, 2.2)),
        path(polygon(((14, 5.5), (5.5, 12), (14, 18.5), (14, 15), (18, 15), (18, 9), (14, 9))), HIGHLIGHT),
    ),
})
