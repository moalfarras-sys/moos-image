...
ICON_FINISH = {
    "nova": "orbit", "nova-light": "orbit",
    "amethyst": "orbit", "amethyst-light": "orbit",
    "midnight": "orbit", "daylight": "orbit",
    "gaming": "facet", "gaming-light": "facet",
    "dev": "facet", "dev-light": "facet",
    "study": "facet", "study-light": "facet",
}
...
def build_icon_theme(key: str, meta: dict) -> None:
    ...
    finish = ICON_FINISH.get(key, "liquid")
    for name, mark in app_icons.MARKS.items():
        master = app_icons.icon_svg(name, mark, finish=finish)
